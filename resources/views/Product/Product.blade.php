...
<div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
    ...
    <form class="p-10 mr-5 ml-5  bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data"  >
      @csrf
        ...
        <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
            ...
            <select class="w-full px-2 py-2 text-gray-700 "  id="catagory" name="catagory_id">
              @foreach ($catagories as $catagory)
                  <option class="text-black " value="{{$catagory->id}}">{{$catagory->catagory_name}}</option>
              @endforeach
              </select>
          </div>
