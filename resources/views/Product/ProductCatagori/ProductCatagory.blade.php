                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b ">
                                            <div class="flex items-center">
                                                <div>
                                                    <div class="text-sm leading-5 text-gray-800">{{$catagory->id}}</div>                                               
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b ">
                                            <div class="flex items-center">
                                                <div>
                                                    <div class="text-sm leading-5 text-gray-800">{{$catagory->user->name}}</div>                                               
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b">
                                            <div class="text-sm leading-5 text-blue-900">{{$catagory->catagory_name}}</div>
                                        </td>
    
                                        <td class="flex p-3">                                      
                                            <a href="{{url('/catagory/edit',$catagory->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
                                                <i class="material-icons-outlined text-base">edit</i>
                                            </a>
                                            <a  href="javascript:void(0)" recordid="{{$catagory->id}}" class="ConfirmDelete text-red-400 hover:text-gray-100 ml-2">
                                                <svg
                                                        class="w-5 "
                                                        aria-hidden="true"
                                                        fill="currentColor"
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           Swal.fire(
            ...
            window.location.href="/catagory/delete/"+recordid;
