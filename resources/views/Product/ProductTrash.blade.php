                                 ...
                                 <tr >
                                    @foreach ($products as $product)   
                                       ...
                                       <td class="px-2 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{$product->catagory->catagory_name}}</td>       
                                        <td><img  width="80px" src="{{ asset('Images/Product/'.$product->img) }}" alt="img"></td>
                                       ...
                                       <td class="px-2 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">                                      
                                        <a href="{{url('/Product/reastore',$product->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
                                            Restore
                                        </a>
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           Swal.fire(
            ...
            window.location.href="/Product/forcedelete/"+recordid;
