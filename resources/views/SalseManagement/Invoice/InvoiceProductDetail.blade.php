                  ...
                  <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
                    ...
                    <div class="w-full  bg-gray-200">
                      <div class="flex justify-between p-4">
                        ...
                        <div class="w-80">
                            <h1 class="font-bold  text-xl">  Export Packing List</h1>   
                            <span class="text-sm">
                              Elamak Baaft.West Kabul Carpet Market
                           </span>                        
                        </div>
                    ...
                    <div class="flex justify-between p-4">
                        <div>
                            <h6 class="font-bold">Order Date : <span class="text-sm font-medium"> {{$InvoiceProductDetail->invoice_date}}</span></h6>
                        
                        </div>
                       
                        <div class="w-40">
                            <address class="text-sm">
                                <span class="font-bold">Ship To : {{$InvoiceProductDetail->client->first_name}} {{$InvoiceProductDetail->client->last_name}}</span>
                    ...
                    <div class="p-2">
                      <ul class=" flex items-end justify-end">
                        ...
                        <p class="text-sm font-bold">Grand Total :  </p>                         
                              <li class="flex flex-col p-2 border-l-2 border-indigo-200">
                                    ...
                                    <p class="text-sm font-bold">Total Square Meter : {{$InvoiceProductDetail->total_square_meters}} </p>
                                   <p class="text-sm font-bold">Total Pieces : {{$InvoiceProductDetail->total_amount}}</p>
                                   <p class="text-sm font-bold">Total Bales : {{$InvoiceProductDetail->total_bales}}</p>
                                   <p class="text-sm font-bold">Total Price : {{$InvoiceProductDetail->total_price}}</p>
                              </li>
                          </ul>
                      </div>
                      ...
                      <div class="w-full  bg-gray-200">
                        ...
                        <div class="flex items-end justify-end space-x-3">
                            ...
                            <a href="{{url('print-pdf-invoice/'.$InvoiceProductDetail['id'])}}" class="px-4 py-2 text-sm text-blue-600 bg-blue-100">Save</a>
