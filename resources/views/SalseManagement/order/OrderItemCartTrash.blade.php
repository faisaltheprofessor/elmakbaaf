                            ...
                            <table   class="min-w-full"> 
                                <thead>                       
                                  <tr >
                                        ...
                                        <th class="px-6 py-3 border-b-2 border-gray-300 text-left leading-4 text-blue-500 tracking-wider">collication </th>
                                 ...
                                 <tr >
                                  ...
                                  @foreach ($orderitem as $orderitem)  
                                       ...
                                       <td class="px-2 flex py-7 whitespace-no-wrap  text-blue-900 border-gray-500 text-sm border-b leading-5">                                      
                                        <a href="{{url('/OrderedItem/reastore',$orderitem->id)}}" class="text-blue-400  mt-8 hover:text-gray-100 mx-2">
                                            Restore
                                        </a>
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    Swal.fire(
                     ...
                     window.location.href="/OrderedItem/forcedelete/"+recordid;
