...
<!----Form of counry  ---->
        ...
        <div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
            ...
            <form  class=" ml-5 mr-5 p-10 bg-white rounded shadow-xl" method="Post">
                @csrf
                <div class="mt-2">
                     <label class="block text-sm text-gray-600" for="">Add Country:</label><br>
                     <input   class="w-full px-2 py-2 text-gray-700" id="" name="country_name" type="text" required="" placeholder="" >
               </div>
                
                  <div class="mt-6">
                     <!---- if id update = ba null bode then show submit butoon -->
                    <button id="result" class="px-4 py-1 text-white font-light tracking-wider bg-blue-700 rounded" value="Post" type="submit">Submit</button>                         
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                                <tr>
                                    ...
                                    <td class="p-3 flex">                                      
                                        <a href="{{url('/country/edit',$country->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
        ...
        $(".ConfirmDelete").click(function(){
            ...
            Swal.fire({
                ...
                Swal.fire(
                    ...
                    window.location.href="/country/delete/"+recordid;
