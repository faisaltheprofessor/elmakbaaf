                                 ...
                                 <tr >
                                    @foreach ($clients as $client)   
                                       ...
                                       <td class="px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5" >{{$client->zip}}</td>
                                        ...
                                        <td class="px-2 flex py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">                                      
                                        <a href="{{url('/client/reastore',$client->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
                                            Restore
                                        </a>
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           Swal.fire(
            ...
            window.location.href="/client/forcedelete/"+recordid;
