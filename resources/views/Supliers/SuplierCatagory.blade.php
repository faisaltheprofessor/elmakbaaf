...
<div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
    ...
    <form  class=" ml-5 mr-5 p-10 bg-white rounded shadow-xl" method="Post">
        @csrf
        <div class="mt-2">
             <label class="block text-sm text-gray-600" for="">Add Catagory</label><br>
             <input   class="w-full px-2 py-2 text-gray-700" id="" name="catagory_name" type="text" required="" placeholder="">
       </div>
    ...
    <form action="" type="get">
        <div class="align-middle rounded-tl-lg rounded-tr-lg inline-block w-full py-4 overflow-hidden bg-white  px-12">
            ...
            <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
                <table class="min-w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Suplier Catagory</th> 
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b ">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-sm leading-5 text-gray-800">{{$scatagory->id}}</div>                                               
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b ">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-sm leading-5 text-gray-800">{{$scatagory->user->name}}</div>                                               
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b">
                                    <div class="text-sm leading-5 text-blue-900">{{$scatagory->catagory_name}}</div>
                                </td>

                                <td class="flex p-3">                                      
                                    <a href="{{url('/scatagory/edit',$scatagory->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
                                        <i class="material-icons-outlined text-base">edit</i>
                                    </a>
                                    <a href="javascript:void(0)"  recordid="{{$scatagory->id}}" class="ConfirmDelete  text-red-400 hover:text-gray-100 ml-2">
                                        <svg
                                            class="w-5 "
                                            aria-hidden="true"
                                            fill="currentColor"
                ...
                {{ $catagories->links('pagination::tailwind') }}
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           Swal.fire(
            ...
            window.location.href="/scatagory/delete/"+recordid;
