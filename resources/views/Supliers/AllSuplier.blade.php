                                 ...
                                 <tr >
                                    @foreach ($supliers as $suplier)   
                                       ...
                                       <td class="px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5" >{{$suplier->zip}}</td>
                                        ...
                                        <td class="flex px-2  py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">                                      
                                        <a href="{{url('/suplier/edit',$suplier->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
