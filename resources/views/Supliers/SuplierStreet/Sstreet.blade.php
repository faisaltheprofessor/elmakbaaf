...
<!----Form of counry  ---->
        ...
        <div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
            ...
            <form  class="p-10 mr-5 ml-5 bg-white rounded shadow-xl" method="Post">
                @csrf
                <div class="mt-2">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b ">
                                        <div class="flex items-center">
                                            <div>
                                                <div class="text-sm leading-5 text-gray-800">{{$sstreet->id}}</div>                                               
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b ">
                                        <div class="flex items-center">
                                            <div>
                                                <div class="text-sm leading-5 text-gray-800">{{$sstreet->user->name}}</div>                                               
                                            </div>
                                        </div>
                                    </td>
                                  
                                    <td class="px-6 py-4 whitespace-no-wrap border-b">
                                        <div class="text-sm leading-5 text-blue-900">{{$sstreet->city->city_name}}</div>
                                    </td>

                                    <td class="px-6 py-4 whitespace-no-wrap border-b">
                                        <div class="text-sm leading-5 text-blue-900">{{$sstreet->street_name}}</div>
                                      </td>

                                    <td class="p-3 flex">                                      
                                        <a href="{{url('/sstreet/edit',$sstreet->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
                                            <i class="material-icons-outlined text-base">edit</i>
                                        </a>
                                        <a href="javascript:void(0)" recordid="{{$sstreet->id}}"  class=" ConfirmDelete  text-red-400 hover:text-gray-100 ml-2">
                                                    <svg
                                                    class="w-5 "
                                                    aria-hidden="true"
                                                    fill="currentColor"
