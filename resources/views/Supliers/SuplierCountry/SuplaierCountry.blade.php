            ...
            <form  class=" mr-5 ml-5 p-10 bg-white rounded shadow-xl" method="Post">
                ...
                <div class="mt-2">
                  ...
                  <div class="mt-6">
                    ...
                    <button  class="px-4 py-1 text-white font-light tracking-wider bg-blue-700 rounded" value="Post" type="submit">Submit</button>                         
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                                <tr>
                                    ...
                                    <td class="p-3 flex">                                      
                                        <a href="{{url('/scountry/edit',$country->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
