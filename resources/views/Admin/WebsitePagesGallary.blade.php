...
<div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
  ...
  @endif
    ...
    <form class=" ml-5 mr-5 p-10 bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data" action="/websitegallary" >
      @csrf
        <p class="text-lg text-gray-800 font-medium pb-4">Add New Picture To Gallary</p>
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           Swal.fire(
            ...
            window.location.href="/websitegallary/delete/"+recordid;
    }
});    
}) 
