...
<div class="border-collapse w-full flex flex-col pt-4 bg-gray-100">
    ...
    <form class="p-10 ml-5 mr-5 bg-white rounded shadow-xl" method="Post" enctype="multipart/form-data" action="/websiteAboteHistory" >
      @csrf
      <p class="text-lg text-gray-800 font-medium pb-4">Add history</p>
      ...
      <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
          <label class="ml-5 block text-sm text-gray-600" for="">Add Picture:</label>
      ...
      <table class="border-collapse w-full ">
        ...
        <thead>
            <tr>
                ...
                <th class="p-3 font-bold uppercase  text-blue-500 border border-gray-300 hidden lg:table-cell">Picture</th>
        ...
        @foreach ($histories as $history) 
            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">                   
               ...
               <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                  <img  width="80px" src="{{ asset('Images/History/'.$history->img) }}"  alt="img"> 
               </td>
              ...
              <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                <div class="flex">
                   <a href="{{url('/websiteAboteHistory/edit',$history->id)}}" class="text-blue-400 hover:text-gray-100 mx-2">
                          <i class="material-icons-outlined text-base">edit</i>
                     </a>
                      <a href="javascript:void(0)" recordid="{{$history->id}}" class="ConfirmDelete text-red-400 hover:text-gray-100 ml-2">
                                    <svg
                                class="w-5 "
                                aria-hidden="true"
                                fill="currentColor"
         ...
         Swal.fire({
           ...
           if (result.isConfirmed) {
             Swal.fire(
              ...
              window.location.href="/websiteAboteHistory/delete/"+recordid;
      }
  });    
  })   
