      ...
      <div class="container grid gap-4 mx-auto lg:grid-cols-5">
             @foreach ($slideshows as $slideshow)
                 <div class="w-full rounded h-50">
                     ...
                     <a href="{{url('/slideshow/reastore',$slideshow->id)}}" class=" ml-5 text-blue-400  py-2 px-4 hover:bg-orange-500  border border-orange-500 hover:border-transparent rounded">
                        Restore  
                     </a>
       ...
       Swal.fire({
         ...
         if (result.isConfirmed) {
           Swal.fire(
            ...
            window.location.href="/slideshow/forcedelete/"+recordid;
    }
});    
})   
